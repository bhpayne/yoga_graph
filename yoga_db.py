...
def pose_properties(DG):
	...
	DG.add_node(8,english_name="lying on back, one leg extended up")
...
# 	DG.node[]["description"]=""
# 	DG.node[]["yogajournalurl"]=""
# 	DG.node[]["hindi_name"]=""
# 	DG.node[]["picture"]=""
# 	DG.node[]["asanas_608_page"]=""
# 	DG.node[]["asanas_608_english"]=""	
...
#	DG.add_weighted_edges_from([(4,6,1)])   # 4 = downward dog; 6 = lay on stomach
	...
	DG.add_weighted_edges_from([(4,47,1)])  # 4 = downward dog; 47 = upward dog
	...
	DG.add_weighted_edges_from([(4,76,1)])  # 4 = downward dog; 76 = inverted tripod

	DG.add_weighted_edges_from([(5,3,1)])   # 5 = dolphin; 3 = child's pose
	DG.add_weighted_edges_from([(5,6,1)])   # 5 = dolphin; 6 = lay on stomach
	DG.add_weighted_edges_from([(5,13,1)])  # 5 = dolphin; 13 = plank
...
#	DG.add_weighted_edges_from([(6,4,1)])   # 6 = lay on stomach; 4 = downward dog
	DG.add_weighted_edges_from([(6,5,1)])   # 6 = lay on stomach; 5 = dolphin
	DG.add_weighted_edges_from([(6,7,1)])   # 6 = lay on stomach; 7 = bow pose
	DG.add_weighted_edges_from([(6,28,1)])  # 6 = lay on stomach; 28 = wheel

	DG.add_weighted_edges_from([(7,6,1)])   # 7 = bow pose; 6 = lay on stomach

	DG.add_weighted_edges_from([(8,9,1)])   # 8 = lying on back, one leg extended up; 9 = both legs extended up
	DG.add_weighted_edges_from([(8,31,1)])  # 8 = lying on back, one leg extended up; 31 = corpse
	...
	DG.add_weighted_edges_from([(13,5,1)])   # 13 = plank; 5 = dolphin
	DG.add_weighted_edges_from([(13,14,1)])  # 13 = plank; 14 = wild thing
	DG.add_weighted_edges_from([(13,15,1)])  # 13 = plank; 15 = low pushup
	DG.add_weighted_edges_from([(13,16,1)])  # 13 = plank; 16 = 
	DG.add_weighted_edges_from([(13,37,1)])  # 13 = plank; 37 = 
	DG.add_weighted_edges_from([(13,48,1)])  # 13 = plank; 48 = 

	DG.add_weighted_edges_from([(14,13,1)])   # 14 = wild thing; 13 = plank
	DG.add_weighted_edges_from([(14,37,1)])   # 14 = wild thing; 37 = 

	DG.add_weighted_edges_from([(15,13,1)])   # 15 = low pushup; 13 = plank
	DG.add_weighted_edges_from([(15,44,1)])   # 15 = low pushup; 44 = crow
	...
	DG.add_weighted_edges_from([(17,68,1)])  # 17 = standing bend; 68 = 
	...
	DG.add_weighted_edges_from([(20,17,1)])   # 20 = stand straight (mountain); 17 = 
	...
	DG.add_weighted_edges_from([(23,48,1)])   # 23 = warrior 3; 48 = 
	...
	DG.add_weighted_edges_from([(28,6,1)])    # 28 = wheel; 6 = lay on stomach
	...
	DG.add_weighted_edges_from([(46,68,1)])   # 46 = standing, legs apart; 68 = 
	...
	DG.add_weighted_edges_from([(68,17,1)])  # 68 = standing bend, legs apart; 17 = 
